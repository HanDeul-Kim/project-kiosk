...
(function() {
    ...
    var logicURL = params.logic ? params.logic : '__LOGIC__./assets/js/visual_logic.js'.replace('__LOGIC__', '');
    var sceneURL = params.load ? params.load : '__URL__bone.gltf'.replace('__URL__', '');
    if (!sceneURL) {
