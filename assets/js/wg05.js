...
targetElem = '#canvas'
//- ----------------------------- model -------------------------------
modelFile = './assets/model/wg05/stegosaurus.glb'
modelScale = 0.75
modelPos = { x: 0, y: -1.15, z: 0 }
...
export function initialFn() {
    ...
    hLight = new THREE.HemisphereLight('#ffffff', 5)
    scene.add(hLight)

    dLight = new THREE.DirectionalLight('#ffe3c2', 5)
    dLight.position.set(2, 2, -1.5);
    ...
    dLight2 = new THREE.DirectionalLight('#ffe3c2', 2)
    dLight2.position.set(-2, 3, 2);
    scene.add(dLight2)

    dLight2 = new THREE.DirectionalLight('#e2e296', 1)
...
export function modelFn2() {
    ...
    const mapHeight = new THREE.TextureLoader().load("assets/img/back05/ny2.jpg");
    mapHeight.wrapS = mapHeight.wrapT = THREE.RepeatWrapping;
    mapHeight.repeat.set(5, 5);
    mapHeight.anisotropy = 5;

    const bumpHeight = new THREE.TextureLoader().load("assets/img/back05/bump.jpg");
    ...
    px = new THREE.TextureLoader().load("assets/img/back05/px.jpg");
    nx = new THREE.TextureLoader().load("assets/img/back05/nx.jpg");
    py = new THREE.TextureLoader().load("assets/img/back05/py.jpg");
    // ny = new THREE.TextureLoader().load("assets/img/back05/ny.jpg");
    pz = new THREE.TextureLoader().load("assets/img/back05/pz.jpg");
    nz = new THREE.TextureLoader().load("assets/img/back05/nz.jpg");
    ...
    floor = new THREE.Mesh(
        ...
        new THREE.MeshPhongMaterial({
            ...
            displacementMap: bumpHeight, //same as map
