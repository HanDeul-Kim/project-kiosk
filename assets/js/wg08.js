...
targetElem = '#canvas'
//- ----------------------------- model -------------------------------
modelFile = './assets/model/wg08/parasaurolophus.glb'
modelScale = 0.55
modelPos = { x: 0.65, y: -1.26, z: 0 }
camInitPos = { x: 6, y: 0, z: -3 }
anyNum = 0
//* ===================================================================
//*                               Main                                 
//* ===================================================================
...
export function modelFn2() {
    ...
    const mapHeight = new THREE.TextureLoader().load("assets/img/back08/ny.jpg");
    mapHeight.wrapS = mapHeight.wrapT = THREE.RepeatWrapping;
    mapHeight.repeat.set(3, 3);
    mapHeight.anisotropy = 5;

    const bumpHeight = new THREE.TextureLoader().load("assets/img/back08/ny3.jpg");
    bumpHeight.wrapS = bumpHeight.wrapT = THREE.RepeatWrapping;
    bumpHeight.repeat.set(5, 5);
    bumpHeight.anisotropy = 5;


    materialArray = [];

    px = new THREE.TextureLoader().load("assets/img/back08/px.jpg");
    nx = new THREE.TextureLoader().load("assets/img/back08/nx.jpg");
    py = new THREE.TextureLoader().load("assets/img/back08/py.jpg");
    ny = new THREE.TextureLoader().load("assets/img/back08/ny.jpg");
    pz = new THREE.TextureLoader().load("assets/img/back08/pz.jpg");
    nz = new THREE.TextureLoader().load("assets/img/back08/nz.jpg");
