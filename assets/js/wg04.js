...
targetElem = '#canvas'
//- ----------------------------- model -------------------------------
modelFile = './assets/model/wg04/pachycephalosaurus.glb'
modelScale = 0.85
modelPos = { x: 0, y: -1.3, z: 0 }
camInitPos = { x: 4.5, y: 0.2, z: -2.0 }
anyNum = 0
//* ===================================================================
//*                               Main                                 
//* ===================================================================
...
export function initialFn() {
    ...
    dLight = new THREE.DirectionalLight('#ffffff', 3)
...
export function modelFn2() {
    ...
    const mapHeight = new THREE.TextureLoader().load("assets/img/back04/ny.jpg");
    mapHeight.wrapS = mapHeight.wrapT = THREE.RepeatWrapping;
    mapHeight.repeat.set(4, 4);
    mapHeight.anisotropy = 5;

    const bumpHeight = new THREE.TextureLoader().load("assets/img/back04/bump.jpg");
    ...
    px = new THREE.TextureLoader().load("assets/img/back04/px.jpg");
    nx = new THREE.TextureLoader().load("assets/img/back04/nx.jpg");
    py = new THREE.TextureLoader().load("assets/img/back04/py.jpg");
    // ny = new THREE.TextureLoader().load("assets/img/back04/ny.jpg");
    pz = new THREE.TextureLoader().load("assets/img/back04/pz.jpg");
    nz = new THREE.TextureLoader().load("assets/img/back04/nz.jpg");
