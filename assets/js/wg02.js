...
export function initialFn() {
    ...
    hLight = new THREE.HemisphereLight('#ffffff', 3)
    scene.add(hLight)

    dLight = new THREE.DirectionalLight('#ffffff', 5)
    dLight.position.set(2, 5, 2);
    dLight.target = scene;
...
export function modelFn2() {
    ...
    px = new THREE.TextureLoader().load("assets/img/back02/px.jpg");
    nx = new THREE.TextureLoader().load("assets/img/back02/nx.jpg");
    py = new THREE.TextureLoader().load("assets/img/back02/py.jpg");
    ny = new THREE.TextureLoader().load("assets/img/back02/ny.jpg");
    pz = new THREE.TextureLoader().load("assets/img/back02/pz.jpg");
    nz = new THREE.TextureLoader().load("assets/img/back02/nz.jpg");
