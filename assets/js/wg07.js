...
targetElem = '#canvas'
//- ----------------------------- model -------------------------------
modelFile = './assets/model/wg07/allosaurus.glb'
modelScale = 0.6
modelPos = { x: -0.1, y: -1.3, z: 0 }
camInitPos = { x: 6, y: 0, z: -1.75 }
anyNum = 0
//* ===================================================================
//*                               Main                                 
//* ===================================================================
...
export function initialFn() {
    ...
    hLight = new THREE.HemisphereLight('#ffffff')
    scene.add(hLight)

    dLight = new THREE.DirectionalLight('#ffffff', 4.5)
    ...
    dLight2 = new THREE.DirectionalLight('#ffffff', 3)
    dLight2.position.set(-1.5, 2, 2);
    scene.add(dLight2)
...
export function modelFn2() {
    ...
    const mapHeight = new THREE.TextureLoader().load("assets/img/back07/ny.jpg");
    mapHeight.wrapS = mapHeight.wrapT = THREE.RepeatWrapping;
    mapHeight.repeat.set(2, 2);
    mapHeight.anisotropy = 5;

    const disHeight = new THREE.TextureLoader().load("assets/img/back07/ny2.jpg");
    disHeight.wrapS = disHeight.wrapT = THREE.RepeatWrapping;
    disHeight.repeat.set(10, 10);
    disHeight.anisotropy = 5;

    const bumpHeight = new THREE.TextureLoader().load("assets/img/back07/bump.jpg");
    bumpHeight.wrapS = bumpHeight.wrapT = THREE.RepeatWrapping;
    bumpHeight.repeat.set(10, 10);
    bumpHeight.anisotropy = 5;


    materialArray = [];

    px = new THREE.TextureLoader().load("assets/img/back07/px.jpg");
    nx = new THREE.TextureLoader().load("assets/img/back07/nx.jpg");
    py = new THREE.TextureLoader().load("assets/img/back07/py.jpg");
    // ny = new THREE.TextureLoader().load("assets/img/back04/ny.jpg");
    pz = new THREE.TextureLoader().load("assets/img/back07/pz.jpg");
    nz = new THREE.TextureLoader().load("assets/img/back07/nz.jpg");
    ...
    floor = new THREE.Mesh(
        new THREE.PlaneBufferGeometry(21, 21, 20, 20),
        // new THREE.MeshBasicMaterial({
        new THREE.MeshPhongMaterial({
            side: THREE.DoubleSide,
            map: mapHeight, //PNG with text and symbols
            displacementMap: disHeight, //same as map
