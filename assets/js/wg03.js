...
targetElem = '#canvas'
//- ----------------------------- model -------------------------------
modelFile = './assets/model/wg03/brachiosaurus.glb'
modelScale = 0.27
modelPos = { x: -0.1, y: -1.5, z: 0 }
camInitPos = { x: 7, y: 0, z: -3 }
anyNum = 0
//* ===================================================================
//*                               Main                                 
//* ===================================================================
...
export function initialFn() {
    ...
    scene.fog = new THREE.Fog(0xfefff3, 0, 30);
    ...
    dLight2 = new THREE.DirectionalLight('#fffff', 2)
...
export function modelFn2() {
    ...
    const mapHeight = new THREE.TextureLoader().load("assets/img/back03/01.jpg");
    mapHeight.wrapS = mapHeight.wrapT = THREE.RepeatWrapping;
    mapHeight.repeat.set(30, 30);
    mapHeight.anisotropy = 1;

    const bumpHeight = new THREE.TextureLoader().load("assets/img/back03/01.jpg");
    bumpHeight.wrapS = bumpHeight.wrapT = THREE.RepeatWrapping;
    bumpHeight.repeat.set(50, 50);
    bumpHeight.anisotropy = 5;


    materialArray = [];

    px = new THREE.TextureLoader().load("assets/img/back03/px.png");
    nx = new THREE.TextureLoader().load("assets/img/back03/nx.png");
    py = new THREE.TextureLoader().load("assets/img/back03/py.png");
    ny = new THREE.TextureLoader().load("assets/img/back03/ny.png");
    pz = new THREE.TextureLoader().load("assets/img/back03/pz.png");
    nz = new THREE.TextureLoader().load("assets/img/back03/nz.png");
